# Generated by Django 4.2.5 on 2023-09-25 01:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("ply_title", models.CharField(blank=True, max_length=500, null=True)),
                ("ply_tag_lst", models.TextField(blank=True, null=True)),
                ("ply_like_cnt", models.IntegerField(blank=True, null=True)),
                ("ply_updt", models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                "db_table": "ply_meta",
                "managed": False,
        ...
        migrations.CreateModel(
            name="SongInPly",
            fields=[
                ("songinply_id", models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("song_name", models.CharField(blank=True, max_length=500, null=True)),
