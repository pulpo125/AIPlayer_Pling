...
if __name__ == "__main__":
    ...
    parser.add_argument('-dimension', type=int, help="hidden layer dimension", default=64) # 450
    parser.add_argument('-epochs', type=int, help="total epochs", default=10) # 41
    parser.add_argument('-batch_size', type=int, help="batch size", default=64) # 256
    ...
    parser.add_argument('-num_workers', type=int, help="num workers", default=0) # 20 오류로 인해 수정
    parser.add_argument('-freq_thr', type=float, help="frequency threshold", default=10) # 빈도수 자르기 기준: 2
    parser.add_argument('-mode', type=int, help="local_val: 0, val: 1, test: 2", default=0) # local_val
    ...
    # one-hot encoding 후 song vec, tag vec concaten
